...
const teams: TeamType[] = [
  {
    ...
    members: [
      ...
      { 
        ...
        name: 'Bob', 
        role: 'UX', 
        profilePic: '/avatars/chicken.png',
        metrics: {
          hoursWorked: 28,
          goalsCompleted: 6,
          totalGoals: 8,
      ...
      <div className="grid gap-6">
        {teams.map((team) => (
          <div key={team.id} className="grid grid-cols-1 xl:grid-cols-4 gap-6">
            ...
            {/* Main team section */}
            <div className="xl:col-span-3 bg-white rounded-xl shadow-xl p-6">
